...
public class QuestManager : MonoBehaviour
{
    ...
    {
        Managers.Questevent.onStartQuest += StartQuest;
        Managers.Questevent.onAdvanceQuest += AdvanceQuest;
        Managers.Questevent.onFinishQuest += FinishQuest;

        Managers.Questevent.onQuestStepStateChange += QuestStepStateChange;
    ...
    private void Start()
    {
        ...
        foreach (Quest quest in questMap.Values)
        {
            ...
            Managers.Questevent.QuestStateChange(quest);
        }
    }
